...
//BASIC ERRORS
"ERROR_NOCOMP"               => "Você não tem uma empresa. Crie uma primeira!",
"ERROR_NOCOMP2"              => "Você não tem uma empresa.",
"ERROR_NOMONEY"              => "Sua empresa não tem dinheiro suficiente em sua conta de pagamento!",
"ERROR_INVALID_NUMBER"       => "Número inválido!",
"ERROR_INVALID_COMP2"        => "Espera .. que empresa você está procurando?",
"ERROR_INVALID_COMP"         => "Essa empresa não existe!",
"ERROR_INVALID_CITY"         => "cidade inválida!",
"ERROR_INVALID_COUNTRY"      => "País inválido!",
"ERROR_INVALID_OBJECT"       => "Objeto inválido!!",
"ERROR_LEVEL_TOO_LOW"        => "Você não tem o nível requerido!",
"ERROR_SELECTED"             => "Selected.",
"ERROR_INVALID_MEMBER"       => "Membro não existe!",
"ERROR_INVALID_REQUEST"      => "Pedido inválido!",


//Premium
"ERROR_PURCHASE_COMPL"           => "Compra concluída.",
"ERROR_PAY_ID_INVALID"           => "ID do pagamento inválido.",
"ERROR_PAYMENT_COMPL"            => "Pagamento concluído.",
"ERROR_PAYMENT_EXP"              => "Pagamento expirado. Por favor, tente novamente.",
"ERROR_PAYMENT_CANCELLED"        => "Você cancelou o pagamento.",
"ERROR_PAYMENT_NOT_ACCEPTED"     => "Pagamento não aceito.",
"ERROR_PREMIUM_BOUGHT"           => "Função Premium comprada.",
"ERROR_NOT_ENOUGH_CREDITS"       => "Você não tem créditos premium suficientes, compre-os primeiro!",
"ERROR_PREMIUM_REQ"              => "Você precisará de uma conta premium para isso.",
